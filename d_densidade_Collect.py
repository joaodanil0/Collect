	...
	for simulacao in range(1, simulacoes+1):
		...
		if os.path.isdir(pathTX):
			...
			if os.path.isdir(path):
				...
				os.system('./d_varia_' + tipoSimulacao + '.py ' + str(num_nos) + ' ' + str(simulacoes) + ' ' + str(simulacao) + ' ' + 
...
if pathExist == True:
	os.system('python3 d_processa_' + tipoSimulacao + '.py ' + str(simulacoes) + ' ' + str(num_nos) + ' ' + str(varia_min) + ' ' + str(varia_max) + ' '+ str(varia_tic))			
